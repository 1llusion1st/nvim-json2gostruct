...
function convert_json_to_go_struct_in_memory(struct_name, json_table)
	local results = {string.format("type %s struct {", struct_name)}
	convert_json_to_gostruct(struct_name, json_table, results, 1, {})
	table.insert(results, "}")
	return results
end

function convert_json_to_gostruct(struct_name, json_table, result_agregator, level, path)
	print("convert_json_to_gostruct", struct_name, json_table)
