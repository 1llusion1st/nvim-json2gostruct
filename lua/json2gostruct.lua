...
function convert_json_to_gostruct(json_table, result_agregator, level)
	...
	if json_table == nil then
		...
		convert_json_to_gostruct(json_table, result_agregator, 1)
		...
		if composed then
			...
			if array then 
				convert_json_to_gostruct(
					value[1], result_agregator, level + 1)
			else
				convert_json_to_gostruct(
					value, result_agregator, level + 1)
			end
...
function get_data_type(obj, name)
	-- print("calculating type of obj: ", type(obj), obj)
